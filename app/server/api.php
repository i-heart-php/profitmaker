<?php
	...
	class API extends REST {
		...
		const DB_USER = "mpvdes_bsi";
		const DB_PASSWORD = "@ut0b0ts";
		const DB = "mpvdes_bsi";
		...
		*/
		...
		private function customers(){	
			...
			$query="SELECT distinct l.id,concat(c.firstname,' ',c.lastname) as customerName, c.email, c.address_line_1 as address, c.city, c.province as state, c.postal_code as postalCode, c.country FROM  leads l, contact_info c WHERE c.id = l.contact_info_id_1 order by l.id desc";
			$r = $this->mysqli->query($query) or die($this->mysqli->error.__LINE__);
